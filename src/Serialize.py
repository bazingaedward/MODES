...
class Serialization(Argument, Settings):
    ...
    def process(self):
        ...
        print("Total costs %s minutes." %
              (int(time.time() - self.startTimer) / 10))
